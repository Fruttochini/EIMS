...
namespace EIMS.Controllers
{
    public class TaskController : Controller
    {
        ...
        public ActionResult CreateTask(long lessonDateID, int groupID, int subjectID, int loid)
        {
        ...
        public ActionResult CreateTask(CreateEditTaskViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    return RedirectToAction("CreateLessonPrecense", "LessonPrecense", new { lessonDateID = model.lessonDateID, groupID = model.groupID, subjectID = model.subjectID, loid = model.loid });
